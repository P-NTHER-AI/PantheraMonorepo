...
import { createDEXService, DEXService } from "../services/dexService";
...
export const useDEXTrading = (tokenAddress: string, userAddress?: string) => {
  ...
  const executeDEXTrade = useCallback(
    ...
    [walletClient, userAddress, tokenAddress]
  );
  ...
  const checkApproval = useCallback(
    ...
    [publicClient, userAddress, tokenAddress]
  );
  ...
  const approveToken = useCallback(
    ...
    [walletClient, userAddress, tokenAddress, publicClient]
  );
