...
import websocketService, { AgentInteraction, PriceUpdate, TradeEvent, WebSocketMessage } from "../services/websocket";
...
export function useWebSocket(options: UseWebSocketOptions = {}) {
  ...
  const serviceApi: WebSocketServiceMethods = {
