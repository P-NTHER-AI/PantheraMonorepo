...
export const formatNumber = (value: string | number | null | undefined, options: FormatNumberOptions = {}): string => {
  const {
    decimals,
    minDecimals = 0,
    maxDecimals = 8,
 ...
 */
export const formatCompactNumber = (value: number, options: { prefix?: string; suffix?: string } = {}): string => {
 ...
 */
export const formatPercentage = (value: string | number | null | undefined, decimals: number = 2): string => {
 ...
 */
export const formatTokenAmount = (amount: string | number | null | undefined, symbol: string = "", decimals: number = 4): string => {
 ...
 */
export const formatAddress = (address: string | null | undefined, startChars: number = 6, endChars: number = 4): string => {
  if (!address) return "";
 ...
 */
export const sanitizeNumericInput = (input: string, options: { allowNegative?: boolean; maxDecimals?: number } = {}): string => {
