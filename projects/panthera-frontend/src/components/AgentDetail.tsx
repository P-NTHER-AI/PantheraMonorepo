import { Activity, ArrowLeft, BarChart3, Copy, MessageCircle, Share2, Star, TrendingDown, TrendingUp } from "lucide-react";
      ...
      <div className="border-b border-[#2a2a2a] bg-[#1a1a1a]">
        <div className="max-w-7xl mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <button onClick={() => navigate("/")} className="flex items-center gap-2 text-[#a0a0a0] hover:text-white transition-colors">
              <ArrowLeft size={20} />
              Back to Agents
            </button>
            ...
            <div className="flex items-center gap-3">
              ...
              >
                <Star size={16} fill={isInWatchlist(agent?.address || agent?.contractAddress || id || "") ? "currentColor" : "none"} />
              ...
              <div className="flex items-start gap-6">
                ...
                <div className="flex-1">
                  <div className="flex items-center gap-3 mb-2">
                    ...
                    <span className="px-3 py-1 bg-[#d8e9ea] text-black text-sm font-medium rounded-full">{agent.tokenSymbol}</span>
                  ...
                  <p className="text-[#a0a0a0] mb-4 leading-relaxed">{agent.agentInfo?.description || agent.description}</p>
                  ...
                  <div className="flex items-center gap-6 text-sm">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-white font-medium">{agent.agentInfo?.model || agent.model || "Unknown"}</span>
                    </div>
                  </div>
                </div>
              </div>
                  ...
                  {[
                    ...
                    <button
                      ...
                      className={`flex items-center gap-2 px-6 py-4 font-medium transition-colors ${
                        activeTab === (tab.id as any) ? "text-[#d8e9ea] border-b-2 border-[#d8e9ea]" : "text-[#a0a0a0] hover:text-white"
                      }`}
                    >
                      <tab.icon size={18} />
                      {tab.label}
              ...
              <div className="p-6">
                ...
                {activeTab === "trading" && (
                  <div className="space-y-6">
                    ...
                    <TradingViewChart agentAddress={agent?.address || id!} tokenSymbol={agent?.tokenSymbol || "TOKEN"} className="w-full" />
                    ...
                    <div className="grid grid-cols-1 xl:grid-cols-3 gap-6">
                      ...
                      <div className="space-y-4">
                        ...
                        <div className="bg-[#0a0a0a] border border-[#2a2a2a] rounded-lg p-4">
                          ...
                          <div
                            className={`text-xl font-bold ${(currentStats?.priceChange24h || 0) >= 0 ? "text-green-400" : "text-red-400"}`}
                          >
                ...
                {activeTab === "chat" && (
                  <div className="text-center py-8">
                    ...
                    <h3 className="text-lg font-semibold text-white mb-2">Chat with {agent.tokenName}</h3>
            ...
            <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-6">
              ...
              <div className="space-y-4">
                ...
                <div>
                  ...
                  <div
                    className={`flex items-center gap-1 ${(currentStats?.priceChange24h || 0) >= 0 ? "text-green-400" : "text-red-400"}`}
                  >
                    {(currentStats?.priceChange24h || 0) >= 0 ? <TrendingUp size={16} /> : <TrendingDown size={16} />}
                    <span className="font-semibold">{Math.abs(currentStats?.priceChange24h || 0).toFixed(2)}%</span>
                  </div>
                </div>
                <div>
            ...
            <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-xl p-6">
              ...
              <div className="space-y-4">
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-medium">{formatNumber(parseFloat(String(agent.totalSupply || "0")))}</span>
                </div>
                <div className="flex justify-between">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="text-white font-medium">${formatNumber(currentStats?.volume24h || 0)}</span>
                </div>
                <div className="flex justify-between">
