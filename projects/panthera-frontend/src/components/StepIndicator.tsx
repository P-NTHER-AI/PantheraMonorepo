        ...
        return (
          <div key={index} className="flex items-center">
            ...
            <div className="flex flex-col items-center">
              ...
              >
                {isCompleted ? <Check size={18} className="animate-in fade-in duration-300" /> : stepNumber}
              </div>

              {/* Step Label */}
              <div className="mt-3 text-center max-w-[120px]">
                <div className={`text-sm font-medium transition-colors ${isActive || isCompleted ? "text-white" : "text-[#a0a0a0]"}`}>
                  {step}
                </div>
              </div>
            </div>
