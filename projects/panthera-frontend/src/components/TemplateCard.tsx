  ...
  return (
    ...
    >
      ...
      <div className="relative z-10">
        ...
        {/* Content */}
        <h3 className="text-white font-semibold text-lg mb-2 group-hover:text-[#d8e9ea] transition-colors">{title}</h3>
        <p className="text-[#a0a0a0] text-sm leading-relaxed group-hover:text-[#e5e5e5] transition-colors">{description}</p>
