...
const FilterBar: React.FC<FilterBarProps> = ({ includeNsfw, sortBy, activeView, onToggleNsfw, onSortChange, onViewChange }) => {
  return (
        ...
        <div className="flex items-center gap-4">
          <button
            ...
            className={`font-medium pb-1 transition-colors ${
              activeView === "explore" ? "text-white border-b-2 border-[#d8e9ea]" : "text-[#a0a0a0] hover:text-white"
            }`}
          >
            Explore
          </button>
          <button
            ...
            className={`font-medium pb-1 transition-colors ${
              activeView === "watchlist" ? "text-white border-b-2 border-[#d8e9ea]" : "text-[#a0a0a0] hover:text-white"
            }`}
          >
            Watchlist
          </button>
        ...
        <div className="flex items-center gap-2">
          ...
          <button
            ...
            className={`px-3 py-1 rounded text-sm font-medium transition-colors ${
              includeNsfw ? "bg-[#d8e9ea] text-black" : "bg-[#2a2a2a] text-[#a0a0a0] hover:bg-[#3a3a3a]"
            }`}
          >
            {includeNsfw ? "On" : "Off"}
          </button>
