import { ArrowLeft, Calendar, ExternalLink, FileText, Mail, Shield, X } from "lucide-react";
...
const More: React.FC<MoreProps> = ({ onBack }) => {
  ...
  const features: FeatureCard[] = [
    ...
    },
    {
      ...
      icon: "🔗",
      title: "Developer API",
      description: "Integrate Panthera agents into your applications",
      status: "coming-soon",
    },
    {
      id: "marketplace",
    ...
    },
    {
      ...
      icon: "🗺️",
      title: "Roadmap",
      description: "See what features are coming next to Panthera",
      status: "coming-soon",
    },
  ];
  ...
  return (
    <div className="min-h-screen bg-[#0a0a0a] ml-[200px]">
      <div className="p-8">
        {/* Header Section */}
        <div className="mb-8">
          <button onClick={onBack} className="flex items-center gap-2 text-[#a0a0a0] hover:text-white mb-6 transition-colors group">
          ...
          <p className="text-[#e5e5e5] text-lg">Explore additional tools, resources, and platform information</p>
        </div>
          ...
          {features.map((feature) => (
            ...
            >
              ...
              <div className="space-y-3">
                <h3 className="text-white text-xl font-semibold group-hover:text-[#d8e9ea] transition-colors">{feature.title}</h3>
        ...
        <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl p-8">
          ...
          <div className="border-t border-[#2a2a2a] mt-6 pt-6">
            <p className="text-[#666] text-sm text-center">
              © 2024 Panthera. All rights reserved. Built with ❤️ for the decentralized AI community.
            </p>
          </div>
        </div>
      </div>
    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center">
      ...
      <div className="relative w-[92vw] max-w-3xl bg-[#111] border border-[#2a2a2a] rounded-2xl shadow-xl">
        ...
        <div className="p-5 max-h-[70vh] overflow-y-auto text-sm leading-6 text-[#e5e5e5] space-y-4">
          <p>
            These Terms of Use constitute a legally binding agreement between you ("you" or "your") and PantheraAI ("PantheraAI", "Entities
            or affiliates", "we", "our" or "us"). These Terms govern your use of all PantheraAI Services made available to you on or through
            the PantheraAI Platform or otherwise. PantheraAI Services may be developed, maintained, and/or provided by PantheraAI Entities
            or affiliates.
          </p>
          <p>
            By accessing the PantheraAI Platform and/or using the PantheraAI Services, you agree that you have read, understood, and
            accepted these Terms, together with any additional documents referenced herein. You acknowledge and agree that you will be bound
            by and will comply with these Terms, as updated and amended from time to time.
          </p>
          <p className="font-semibold">
            BY ACCESSING THE PANTHERAAI PLATFORM AND USING PANTHERAAI SERVICES, YOU IRREVOCABLY WAIVE YOUR RIGHT TO PARTICIPATE IN A CLASS
            ACTION OR SIMILAR MASS ACTION IN ANY JURISDICTION OR BEFORE ANY TRIBUNAL. YOU ALSO EXPRESSLY AGREE THAT ANY CLAIMS AGAINST ANY
            PANTHERAAI-RELATED ENTITY OR AFFILIATE WILL BE SUBJECT TO MANDATORY, BINDING ARBITRATION.
          </p>
          <p>If you do not understand and accept these Terms in their entirety, you should not use the PantheraAI Platform.</p>

          <h4 className="text-white font-semibold mt-2">Risk Warning</h4>
          <p>
            The PantheraAI Platform and PantheraAI Services involve deploying, interacting with, and transacting in AI Agents and tokenized
            AI assets. Neither PantheraAI Entities nor affiliates are responsible for AI Agents, models, or tokenized assets created or
            deployed by other users that you may engage with on the PantheraAI Platform. Please ensure you fully understand the risks before
            using PantheraAI Services.
          </p>
          <ul className="list-disc pl-5 space-y-2">
            <li>
              <span className="font-medium">Capital Loss Risk:</span> Tokenized AI assets are highly volatile and may result in the total
              loss of your investment.
            </li>
            <li>
              <span className="font-medium">Smart Contract Risk:</span> Vulnerabilities or exploits may lead to irreversible loss of funds.
            </li>
            <li>
              <span className="font-medium">Performance Risk:</span> Poor or malicious AI Agent performance may result in operational
              failure or economic loss.
            </li>
            <li>
              <span className="font-medium">Market Risk:</span> Demand for AI-powered services may fluctuate unpredictably.
            </li>
            <li>
              <span className="font-medium">Regulatory Risk:</span> Legal or regulatory changes may impact PantheraAI operations or your
              ability to use the platform.
            </li>
          </ul>
          <p>
            PantheraAI is not your broker, advisor, or fiduciary. No communication or information from PantheraAI should be considered
            investment, legal, or tax advice. You are solely responsible for evaluating whether deploying, using, or investing in AI Agents
            and tokenized assets aligns with your risk tolerance and financial situation.
          </p>

          <h4 className="text-white font-semibold mt-2">1. Introduction</h4>
          <ol className="list-decimal pl-5 space-y-2">
            <li>
              PantheraAI Entities and their affiliates develop, maintain, operate, and provide access to the PantheraAI Platform and
              PantheraAI Services.
            </li>
            <li>
              By using the PantheraAI Platform or Services, you enter into a legally binding agreement with all PantheraAI Entities and
              affiliates.
            </li>
            <li>
              You acknowledge that you must read these Terms carefully and are responsible for informing us if you do not understand any
              part.
            </li>
            <li>You agree to comply with any additional terms applicable to specific PantheraAI Services.</li>
          </ol>

          <h4 className="text-white font-semibold mt-2">2. Eligibility</h4>
          <ol className="list-decimal pl-5 space-y-2">
            <li>
              To use PantheraAI Services, you must be of legal age and capacity, have full authority to enter these Terms, and not be in a
              prohibited jurisdiction or on any sanctions list.
            </li>
            <li>PantheraAI may change eligibility criteria at its sole discretion without prior notice.</li>
          </ol>

          <h4 className="text-white font-semibold mt-2">3. Platform Use</h4>
          <ol className="list-decimal pl-5 space-y-2">
            <li>PantheraAI may refuse, limit, or terminate your access for any reason.</li>
            <li>You must not upload or distribute any harmful, fraudulent, or illegal content through PantheraAI.</li>
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li>Fees for PantheraAI Services will be displayed before use and must be paid in full.</li>
            <li>PantheraAI reserves the right to modify fees at any time.</li>
          </ol>

          <h4 className="text-white font-semibold mt-2">5. Transactions</h4>
          <ol className="list-decimal pl-5 space-y-2">
            <li>All blockchain transactions through PantheraAI are final and irreversible.</li>
            <li>PantheraAI is not responsible for failed transactions due to network issues, insufficient funds, or user error.</li>
          </ol>
          ...
          <ol className="list-decimal pl-5 space-y-2">
            ...
            <li>PantheraAI will never ask for your private keys or passwords.</li>
          </ol>

          <h4 className="text-white font-semibold mt-2">7. Intellectual Property</h4>
          <ol className="list-decimal pl-5 space-y-2">
            <li>PantheraAI retains ownership of all platform IP, branding, and software.</li>
            <li>
              You retain ownership of AI Agents you create but grant PantheraAI a license to host and display them as necessary for platform
              operation.
            </li>
          </ol>
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li>PantheraAI Services are provided "as is" without warranties.</li>
            <li>PantheraAI is not liable for losses arising from use of the platform, except as required by law.</li>
          </ol>
          ...
          <p>For questions, contact PantheraAI Support at [support link].</p>
        </div>
      </div>
    </div>
  );
  ...
  return (
    <div className="fixed inset-0 z-[70] flex items-center justify-center">
      ...
      <div className="relative w-[92vw] max-w-3xl bg-[#111] border border-[#2a2a2a] rounded-2xl shadow-xl">
        ...
        <div className="p-5 max-h-[70vh] overflow-y-auto text-sm leading-6 text-[#e5e5e5] space-y-4">
          <p>
            <strong>Last updated:</strong> 15 Aug 2025
          </p>

          <p>
            This Cookie Policy explains how <strong>PantheraAI</strong> (“PantheraAI”, “we”, “us”, or “our”) uses cookies and similar
            technologies on the PantheraAI Platform and related services. It should be read together with our Terms of Service and Privacy
            Policy.
          </p>

          <h4 className="text-white font-semibold mt-2">What are cookies?</h4>
          <p>
            Cookies are small text files stored on your device when you visit a website. We also use localStorage and similar technologies
          ...
          <p className="text-[#a0a0a0] text-xs">*Third-party tools are used only if enabled in our stack and may change over time.</p>
          ...
          <p>
            Strictly necessary cookies rely on legitimate interests; others rely on your consent, which you can withdraw at any time through
            available controls.
          </p>

          <h4 className="text-white font-semibold mt-2">California (CCPA/CPRA)</h4>
          <p>
            We do not “sell” personal information. If marketing cookies are enabled, some may constitute “sharing” for cross-context
            behavioral advertising. You can exercise your rights via available preference controls.
          </p>

          <h4 className="text-white font-semibold mt-2">Retention &amp; updates</h4>
          <p>
            Cookie data persists for the durations above unless you delete it earlier. We may update this Policy, and changes will be posted
          ...
          <p>
            Questions? Contact{" "}
            <a href="mailto:support@ursus.ai" className="text-[#d8e9ea] underline">
              support@ursus.ai
            </a>
            .
          </p>
    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center">
      ...
      <div className="relative w-[92vw] max-w-3xl bg-[#111] border border-[#2a2a2a] rounded-2xl shadow-xl">
        ...
        <div className="p-5 max-h-[70vh] overflow-y-auto text-sm leading-6 text-[#e5e5e5] space-y-4">
          ...
          <p>
            At <strong>PantheraAI</strong>, we prioritize the security of our users, infrastructure, and smart contracts. This Security
            Notice summarizes our current practices and your responsibilities when using the platform.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>Secrets kept outside source control; no private keys are ever requested by PantheraAI.</li>
          ...
          <p>
            ...
            <a href="mailto:security@ursus.ai" className="text-[#d8e9ea] underline">
              security@ursus.ai
            </a>{" "}
          ...
          <p>We may update this notice periodically. Material changes will be reflected here with an updated date.</p>
        </div>
      </div>
    </div>
  );
    ...
    <div className="fixed inset-0 z-[70] flex items-center justify-center">
      ...
      <div className="relative w-[92vw] max-w-3xl bg-[#111] border border-[#2a2a2a] rounded-2xl shadow-xl">
        ...
        <div className="p-5 max-h-[70vh] overflow-y-auto text-sm leading-6 text-[#e5e5e5] space-y-4">
          ...
          <p>
            This Privacy Policy explains how <strong>PantheraAI</strong> (“we”, “us”, “our”) collects, uses, and protects your information
            when you use the PantheraAI Platform and Services.
          </p>

          <h4 className="text-white font-semibold mt-2">1. Information We Collect</h4>
          <ul className="list-disc pl-5 space-y-1">
            <li>
              <strong>Wallet data:</strong> public addresses, on-chain interactions relevant to the platform.
            </li>
            <li>
              <strong>Usage data:</strong> pages visited, feature interactions, diagnostics, crash logs.
            </li>
            <li>
              <strong>Optional data:</strong> email, social links (Twitter/Discord/GitHub) if you provide them.
            </li>
            <li>
              <strong>Cookies & similar:</strong> see our Cookie Policy for details.
            </li>
          </ul>
          ...
          <p>
            Where applicable (e.g., EEA/UK), we process data based on performance of a contract, legitimate interests, legal obligations,
            and consent (for optional features/marketing).
          </p>
          ...
          <p>Data may be processed globally. Where required, we use appropriate safeguards (e.g., SCCs) for transfers.</p>

          <h4 className="text-white font-semibold mt-2">6. Data Retention</h4>
          <p>
            We retain information only as long as necessary for the purposes described or as required by law. You may request deletion
            subject to legal/operational constraints.
          </p>
          ...
          <ul className="list-disc pl-5 space-y-1">
            ...
            <li>
              ...
              <a href="mailto:privacy@ursus.ai" className="text-[#d8e9ea] underline">
                privacy@ursus.ai
              </a>
            </li>
          </ul>
          ...
          <p>
            The Services are not directed to children under the age required by local law. Do not use the platform if you do not meet the
            minimum age.
          </p>

          <h4 className="text-white font-semibold mt-2">9. Security</h4>
          <p>
            We implement technical and organizational measures to protect information. No method of transmission or storage is 100% secure.
            See our Security notice for more details.
          </p>

          <h4 className="text-white font-semibold mt-2">10. Cookies</h4>
          <p>We use cookies and similar technologies. For details and choices, see the Cookie Policy.</p>
