    ...
    <div className="p-6 bg-gray-900 text-white min-h-screen">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-gray-800 p-4 rounded-lg">
          ...
          <div className="mt-4 space-y-2">
            <div className="space-x-2">
              <button onClick={handleManualConnect} className="px-3 py-1 bg-blue-600 hover:bg-blue-700 rounded text-sm">
                Force Connect
              </button>
              <button onClick={handleManualReconnect} className="px-3 py-1 bg-green-600 hover:bg-green-700 rounded text-sm">
                Reconnect
              </button>
            </div>
            ...
            <div className="border-t border-gray-700 pt-3">
              ...
              <div className="grid grid-cols-2 gap-2">
                <button onClick={runConnectionTest} className="px-3 py-2 bg-green-600 hover:bg-green-700 rounded text-xs">
                  Connection Test
                </button>
                <button onClick={runSubscriptionTest} className="px-3 py-2 bg-purple-600 hover:bg-purple-700 rounded text-xs">
                  Subscription Test
                </button>
                <button onClick={runMessageTest} className="px-3 py-2 bg-orange-600 hover:bg-orange-700 rounded text-xs">
                  Message Test
                </button>
                <button onClick={runReconnectionTest} className="px-3 py-2 bg-red-600 hover:bg-red-700 rounded text-xs">
                  Reconnection Test
                </button>
              </div>
              <button
              ...
              <div className="space-y-1 text-xs">
                {Object.entries(testResults).map(([test, result]) => (
                  <div key={test} className="flex justify-between">
                    ...
                    <span
                      className={`font-mono ${result === true ? "text-green-400" : result === false ? "text-red-400" : "text-gray-400"}`}
                    >
        ...
        <div className="bg-gray-800 p-4 rounded-lg">
          ...
          <button onClick={() => setLogs([])} className="mt-2 px-3 py-1 bg-red-600 hover:bg-red-700 rounded text-sm">
            Clear Logs
          </button>
        </div>
      </div>
      ...
      {connectionHealth && (
        <div className="mt-6 bg-gray-800 p-4 rounded-lg">
          ...
          <pre className="bg-black p-3 rounded text-sm overflow-x-auto">{JSON.stringify(connectionHealth, null, 2)}</pre>
        </div>
      )}
    </div>
  );
