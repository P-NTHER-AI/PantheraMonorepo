            ...
            >
              {agent.bondingCurveInfo?.reserve && Number(agent.bondingCurveInfo.reserve) >= 30000 && (
                <div className="absolute top-3 right-3">
                  <span className="bg-yellow-500/20 text-yellow-300 text-xs px-2 py-0.5 rounded-md border border-yellow-500/30">
                    🏆 Graduated
                  </span>
                </div>
              )}
              <div className="flex items-start gap-3 mb-3">
                ...
                <div className="flex-1">
                  ...
                  <div className="text-[#10b981] text-sm font-medium">{formatMarketCap(agent.marketCap)}</div>
              ...
              <div className="text-[#e5e5e5] text-sm mb-3 line-clamp-3">{agent.description}</div>
