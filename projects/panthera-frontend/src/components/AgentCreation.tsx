...
const AgentCreation: React.FC<AgentCreationProps> = ({ onBack }) => {
  ...
  const steps = ["Instructions", "Model & Settings", "Token Configuration", "Deploy & Launch"];
  ...
  const templates = [
    {
      ...
      icon: "💎",
      description:
        "You are a DeFi research assistant that analyzes yield farming opportunities across Core Network protocols. Monitor liquidity pools, calculate APY rates, and provide risk assessments for various DeFi strategies.",
    },
    {
      title: "Content Creator",
      icon: "📝",
      description:
        "You are a creative content generator that produces engaging social media posts, blog articles, and marketing copy. Focus on viral content patterns, SEO optimization, and audience engagement strategies.",
    },
    {
      title: "Trading Bot",
      icon: "⚡",
      description:
        "You are a cryptocurrency trading analyst that provides real-time market analysis and trading signals. Use technical indicators, sentiment analysis, and on-chain data to generate actionable trading insights.",
    },
    {
      title: "Research Assistant",
      icon: "🔬",
      description:
        "You are a comprehensive research assistant that analyzes market trends, compiles reports, and provides data-driven insights. Synthesize information from multiple sources and present clear, actionable findings.",
    },
    {
      title: "Social Media Manager",
      icon: "📱",
      description:
        "You are a social media management expert that creates content calendars, analyzes engagement metrics, and optimizes posting strategies across multiple platforms to maximize reach and engagement.",
    },
    {
      title: "Code Reviewer",
      icon: "⚙️",
      description:
        "You are a smart contract auditor and code reviewer that identifies vulnerabilities, suggests optimizations, and ensures best practices in blockchain development. Focus on security and gas efficiency.",
    },
  ];
  ...
  const handleTokenLogoChange = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      const normalizedUrl = result.imageUrl?.startsWith("http") ? result.imageUrl : `${backendRoot}${result.imageUrl}`;
          ...
          if (isTxHash) {
            try {
              ...
              if (error instanceof Error && error.message === "TOKEN_NOT_FOUND") {
                ...
                alert("Token not found: Backend has not indexed the agent yet.");
              } else {
                // dispatchToast({ type: 'warning', title: 'Awaiting index', message: 'Waiting for agent address indexing...' });
                alert("Awaiting index: Waiting for agent address indexing...");
              }
    ...
    <div className="min-h-screen bg-[#0a0a0a] ml-[200px]">
      <div className="p-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#e5e5e5] text-lg">Deploy an AI agent with its own token in minutes</p>
        </div>
          ...
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl p-10 shadow-2xl">
              ...
              <div className="text-center mb-8">
                <h2 className="text-white text-3xl font-semibold mb-3">Describe Your AI Agent</h2>
                <p className="text-[#a0a0a0] text-lg">Tell your agent what to do and how to behave</p>
              </div>
              ...
              <div className="mb-8">
                <div className="relative">
                  ...
                  {/* Character Counter */}
                  <div className="absolute bottom-4 right-4 text-sm text-[#666]">{charCount}/2000</div>
                </div>
              </div>

              {/* Template Gallery */}
              <div className="mb-8">
                <h3 className="text-white text-xl font-medium mb-6 text-center">Quick Start Templates</h3>
          ...
          <div className="max-w-5xl mx-auto">
            <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl p-10 shadow-2xl">
              ...
              <div className="text-center mb-10">
                <h2 className="text-white text-3xl font-semibold mb-3">Choose AI Model & Configure Settings</h2>
                <p className="text-[#a0a0a0] text-lg">Select the AI engine and customize your agent's behavior</p>
              </div>
                    ...
                    >
                      ...
                      <div
                        className={`absolute top-4 right-4 w-6 h-6 rounded-full border-2 flex items-center justify-center transition-all ${
                          selectedModel === model.id ? "border-[#d8e9ea] bg-[#d8e9ea]" : "border-[#666]"
                        }`}
                      >
                        {selectedModel === model.id && <Check size={14} className="text-black animate-in fade-in duration-200" />}
                      </div>
                      ...
                      <div className="flex items-start gap-4 mb-4">
                        ...
                        <div className="flex-1">
                          ...
                          <p className="text-[#a0a0a0] text-sm">{model.description}</p>
                        </div>
                      </div>
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                  ...
                  <div className="flex items-center justify-between p-4 bg-[#0a0a0a] border border-[#2a2a2a] rounded-xl">
                    ...
                    <button
                      ...
                      className={`relative w-12 h-6 rounded-full transition-colors ${memoryRetention ? "bg-[#d8e9ea]" : "bg-[#2a2a2a]"}`}
                    >
                      <div
                  ...
                  <div className="flex items-center justify-between p-4 bg-[#0a0a0a] border border-[#2a2a2a] rounded-xl">
                    ...
                    <button
                      ...
                      className={`relative w-12 h-6 rounded-full transition-colors ${multiLanguage ? "bg-[#d8e9ea]" : "bg-[#2a2a2a]"}`}
                    >
                      <div
                        className={`absolute top-1 w-4 h-4 bg-white rounded-full shadow-md transition-transform ${
        ...
        {currentStep === 3 && (
          <div className="max-w-6xl mx-auto">
            <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl p-10 shadow-2xl">
              {/* Section Title */}
              <div className="text-center mb-10">
                <h2 className="text-white text-3xl font-semibold mb-3">Configure Your Token</h2>
                <p className="text-[#a0a0a0] text-lg">Set up your agent's token economics and branding</p>
              </div>
              ...
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
                ...
                <div className="space-y-6">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      />
                      <div className="absolute right-4 top-1/2 transform -translate-y-1/2 text-[#666] text-sm">Auto-generated</div>
                    </div>
                  </div>
                  ...
                  <div className="space-y-4">
                    <div className="flex items-center justify-between">
                      ...
                      <span className="text-[#a0a0a0] text-sm">{initialSupply.toLocaleString()} tokens</span>
                    </div>
                    <div className="relative">
                      <input
                        type="range"
                        ...
                        className="w-full h-2 bg-[#2a2a2a] rounded-lg appearance-none cursor-pointer slider"
                        style={{
                          background: `linear-gradient(to right, #d8e9ea 0%, #d8e9ea ${
                            ((initialSupply - 1000000) / (1000000000 - 1000000)) * 100
                          }%, #2a2a2a ${((initialSupply - 1000000) / (1000000000 - 1000000)) * 100}%, #2a2a2a 100%)`,
                        }}
                      />
                    </div>
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="border-2 border-dashed border-[#2a2a2a] rounded-xl p-8 text-center hover:border-[#d8e9ea] transition-colors cursor-pointer">
                      <input type="file" accept="image/*" onChange={handleTokenLogoChange} className="hidden" id="token-logo-upload" />
                      <label htmlFor="token-logo-upload" className="cursor-pointer">
                        <Upload size={32} className="text-[#666] mx-auto mb-3" />
                        <p className="text-[#a0a0a0] mb-2">{tokenLogo ? tokenLogo.name : "Click to upload logo"}</p>
                ...
                <div className="space-y-6">
                  ...
                  <div className="bg-[#0a0a0a] border border-[#2a2a2a] rounded-xl p-6">
                    ...
                    <p className="text-[#a0a0a0] text-sm mt-2">Price increases with each token purchase</p>
                  </div>
                  ...
                  <div className="bg-[#0a0a0a] border border-[#2a2a2a] rounded-xl p-6">
                    ...
                    <div className="text-2xl font-bold text-[#d8e9ea] mb-2">${(initialSupply * 0.001).toLocaleString()}</div>
                    <p className="text-[#a0a0a0] text-sm">Estimated initial market cap</p>
                  </div>
        ...
        {currentStep === 4 && (
          <div className="max-w-4xl mx-auto">
            <div className="bg-[#1a1a1a] border border-[#2a2a2a] rounded-2xl p-10 shadow-2xl">
              {/* Section Title */}
              <div className="text-center mb-10">
                <h2 className="text-white text-3xl font-semibold mb-3">Deploy & Launch</h2>
                <p className="text-[#a0a0a0] text-lg">Review costs and deploy your AI agent with token</p>
              </div>
