...
class AIService {
  ...
  buildSystemPrompt(instructions, userAddress = null, agentData = null) {
    let systemPrompt = `${instructions}\n\nYou are an AI agent on the Core DAO blockchain. You should:
...
- You can mention these stats when relevant to the conversation`;
  ...
  generateAgentPersonality(category, instructions) {
    const personalities = {
      ...
      General: 'You are a well-rounded AI assistant with broad knowledge across all aspects of blockchain, DeFi, and the Core DAO ecosystem.'
    };
