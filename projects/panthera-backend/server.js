...
async function startServer() {
  try {
    ...
    const dataProcessor = new RealTimeDataProcessor(blockchainService, databaseService, websocketService);
    ...
    console.log("🚀 Ready to receive real agent deployments from Core testnet!");

    // Start server
    console.log(`🔧 Attempting to start server on port ${PORT}...`);
    server.listen(PORT, () => {
      console.log(`🚀 PANTHERA Backend API running on port ${PORT}`);
